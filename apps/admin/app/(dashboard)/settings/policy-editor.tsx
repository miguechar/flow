...
import type { Policy } from "@workspace/db"

export function PolicyEditor({ initialPolicy }: { initialPolicy: Policy | null }) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          This policy is shown to clients before they book. They must agree to it before
