...
import { db, appointmentRequests, appointments, user } from "@workspace/db"
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Here&apos;s what&apos;s happening at Flow Massage today.</p>
      </div>
            ...
            {recentRequests.map((req) => (
              <div key={req.id} className="flex items-center justify-between p-4 rounded-lg border bg-card">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{req.email} · {req.serviceType}</p>
                </div>
