      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-16rem)] px-4 py-16">
        <div className="text-center max-w-sm space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            A confirmation will be sent to <strong>{userEmail}</strong>. Your
            card will only be charged after your session is complete.
          </p>
        </div>
      </div>
    );
    ...
    <div className="py-12 md:py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Hi {userName?.split(" ")[0] ?? "there"}! Your{" "}
            <strong>{request.serviceType}</strong> request has been approved.
          </p>
        </div>
            ...
            return (
              <div key={s.id} className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  <div
                    className={`size-8 rounded-full flex items-center justify-center text-sm font-medium border-2 transition-colors ${
                      isPast
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Select your preferred appointment date and time slot. Weekends are
          unavailable.
        </CardDescription>
      </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            >
              ...
              , including the cancellation policy, late arrival policy, and
              payment terms.
            </label>
          </div>
      ...
      <Dialog open={policyOpen} onOpenChange={setPolicyOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Full policy — please read carefully.
            </DialogDescription>
          </DialogHeader>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Your card will be saved securely but <strong>not charged</strong>{" "}
          until after your session.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {/* Booking summary */}
