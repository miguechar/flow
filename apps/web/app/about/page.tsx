...
export const metadata: Metadata = {
  ...
  description: "Learn about your therapist and the philosophy behind Flow Massage.",
}
    ...
    <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center md:justify-end order-first md:order-last">
              <div className="relative">
                <div className="size-72 md:size-96 rounded-3xl bg-primary/10 border-2 border-primary/20 flex flex-col items-center justify-center gap-3 text-primary/40">
                  ...
                  <span className="text-sm font-medium text-muted-foreground">Therapist Photo</span>
                </div>
                {/* Accent dot */}
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                I&apos;m a licensed massage therapist with over 8 years of experience helping
                clients reconnect with their bodies, release chronic tension, and restore
                a sense of ease and flow in their daily lives.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                My approach is deeply personal. I believe that every body has its own story,
                and every session should reflect your unique needs — whether that&apos;s deep
                pressure work to untangle stubborn knots, or a gentle, restorative treatment
      ...
      <section className="py-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <blockquote className="text-xl md:text-2xl text-muted-foreground leading-relaxed italic font-light">
            &ldquo;The body holds wisdom we often forget to listen to. Massage is not a luxury —
            it&apos;s a conversation between therapist and client, between tension and release,
            between pain and healing.&rdquo;
          </blockquote>
          <Separator className="my-10 max-w-xs mx-auto" />
          <p className="text-muted-foreground leading-relaxed">
            I founded Flow Massage to create a space where clients feel truly heard and cared for.
            From your first inquiry to your last exhale on the table, my goal is to make every
            interaction personal, professional, and healing.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight mb-3">Specialties</h2>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold tracking-tight mb-3">Credentials & Training</h2>
      ...
      <section className="py-16 bg-primary/5 border-t">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl font-bold mb-3">Ready to experience the difference?</h2>
          <p className="text-muted-foreground mb-6">
            Request an appointment and I&apos;ll reach out to schedule your session personally.
          </p>
          <Link href="/request">
